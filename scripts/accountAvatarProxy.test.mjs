...
test('registration draft images allow 2 MiB sources plus base64 overhead only on draft writes', async () => {
  ...
  for (const [method, path] of [['POST', '/api/platform/seasons/FCW26/registration/drafts'], ['PATCH', '/api/platform/seasons/FCW26/registration/drafts/test-id'], ['PUT', '/api/platform/seasons/FCW26/registration/drafts/test-id/logo']]) {
