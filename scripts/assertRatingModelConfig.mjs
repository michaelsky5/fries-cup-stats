...
assert.equal(resolveHeroSubrole('D.Mon').canonicalHeroName, 'D.Mon')
assert.equal(resolveHeroSubrole('D.Mon').resolvedSubrole, 'TANK')
assert.equal(resolveHeroSubrole('D.Mon').scoringProfile, 'brawl_tank')
assert.equal(resolveHeroSubrole('DMon').canonicalHeroName, 'D.Mon')
assert.ok(PROFILE_WEIGHTS.brawl_tank.appliesTo.includes('D.Mon'))
