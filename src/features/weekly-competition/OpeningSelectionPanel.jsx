...
function OpeningForm({ data, disabled, mutate }) {
  ...
  const [draft, setDraft] = useState(() => loadDraft(key)), [role, setRole] = useState('TANK'), [storageError, setStorageError] = useState('')
