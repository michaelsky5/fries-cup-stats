...
export default function OpeningMethodControl({ opening, disabled, send }) {
  ...
  const method = opening.firstPick || { mode: 'RPS', modeLabel: '石头剪刀布', configuredMode: 'INHERIT', sourceLabel: '赛季默认' }
