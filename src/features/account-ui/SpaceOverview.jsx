...
export default function SpaceOverview({ context, withSeason, sections, managerStatus, playerStatus, registrationEntry, followingSummary, children, weekly, activity, preparation, locale = 'zh-CN' }) {
