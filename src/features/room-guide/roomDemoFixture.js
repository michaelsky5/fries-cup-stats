...
export function buildWeeklyRoomPreview(stage = 'lineup', role = 'representative') {
  ...
  if (stage === 'confirming') {
    opening.winner = null; opening.setup = null; map.firstBanSide = ''
    opening.firstPick = { mode: 'MANUAL', modeLabel: '双方确认', sourceLabel: '示例规则', confirmations: [{ side: 'A', chooserSide: 'A', by: '示例代表 A' }, { side: 'B', chooserSide: null }], evidence: [] }
