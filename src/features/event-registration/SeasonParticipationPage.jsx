...
function Registration({ eligibilityRequired, record, userId, owner, canWrite, busy, perform, invitationLinks, rosterMin = 1, rosterMax = 7, onRefresh }) {
  const uiLocale = useUiLocale()
