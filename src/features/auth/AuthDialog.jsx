...
export default function AuthButton({ locale = 'zh-CN', dialogOnly = false }) {
  ...
  const roomsHref = competition.link(withSeason('/me?section=matches', getInitialSeasonId(), location.search))
