      ...
      <div className={styles.mirrorRows}>
        {comparison.rows.map(row => (
          <div key={row.key} className={styles.mirrorRow} data-negative={row.lowerIsBetter ? 'true' : 'false'}>
            <span
              className={styles.mirrorValue}
              data-leader={row.leader === 'A' ? 'true' : 'false'}
            >
              <b className={styles.mirrorNumber}>{row.aLabel}</b>
            </span>
            ...
            <span
              className={styles.mirrorValueRight}
              data-leader={row.leader === 'B' ? 'true' : 'false'}
            >
              <b className={styles.mirrorNumber}>{row.bLabel}</b>
            </span>
          </div>
        ))}
      </div>
