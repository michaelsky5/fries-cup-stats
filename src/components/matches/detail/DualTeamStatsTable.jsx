...
import SignalMapStats from './SignalMapStats.jsx'
...
export default function DualTeamStatsTable({ map, dossier, seasonId, locale = 'zh-CN', t, signal = false, withSeason, returnState, onPlayerNavigate }) {
  ...
  if (signal) return <SignalMapStats map={map} dossier={dossier} teamADisplayRows={teamADisplayRows} teamBDisplayRows={teamBDisplayRows} awardIndex={awardIndex} columns={GAME_STAT_COLUMNS} seasonId={seasonId} locale={locale} t={t} withSeason={withSeason} returnState={returnState} onPlayerNavigate={onPlayerNavigate} />
