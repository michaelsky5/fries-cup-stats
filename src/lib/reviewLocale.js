...
import { refineReviewScene } from './reviewEditorial.js'
import { LOCALES, normalizeLocale, getLocaleParam, getStoredLocale, setStoredLocale } from './locales.js'
...
const UI_COPY = {
  'zh-CN': {
    ...
    storyNavigation: '回顾章节', recordNote: '档案说明', keepsakeShort: '领取纪念图', witnessShort: '制作见证票', letterShort: '最后一封信',
    copyScene: '复制这一幕链接', sceneCopied: '章节链接已复制', sceneCopyFailed: '未能复制，请复制下方链接', sceneLink: '当前章节链接',
    retryGenerate: '重新生成', ticketUse: '把身份和赛季数据收进一张横版纪念票，适合留存。',
    posterUse: '竖版构图突出你的名字，适合手机浏览与社交分享。', movieTicketUse: '以电影票保存赛季主题与个人署名，适合横版分享。', directorCutUse: '选择英雄与专属美术风格，制作自己的导演剪辑版。',
    ...
    ticketFormat: '横版赛季机票', filmPosterFormat: '竖版电影海报', movieTicketFormat: '横版首映电影票', directorCutFormat: '导演剪辑版',
    directorArtDirection: '导演美术方向', directorAllHeroes: '全部英雄设计',
    directorAutoSignature: '自动 · 赛季代表英雄', directorSeasonCast: '本季出演', directorChooseHero: '选择一位英雄',
    directorHeroHelpPlayer: '默认采用赛季代表英雄。手动选择会同时更换英雄立绘与专属视觉母题，并在票面标注 DIRECTOR’S CHOICE。',
    directorHeroHelpIdentity: '先选择一位英雄。英雄将成为电影票的银幕主角；你的姓名、身份与赛季数据仍然完整保留。',
    directorChoiceSignature: '赛季代表', directorChoiceManual: '导演选择', directorChoiceUnselected: '等待选择',
    directorSubject: '银幕主角', directorSubjectHero: '英雄立绘', directorSubjectPending: '等待英雄',
    directorChooseHeroPreview: '选择英雄后，将按该英雄的专属构图、辅助色与视觉母题自动生成电影票。',
    directorChooseHeroFirst: '请先选择一位英雄。',
    directorRoleTank: '重装', directorRoleDamage: '输出', directorRoleSupport: '支援',
    posterOutputPortrait: '竖版 1080×1920', posterOutputLandscape: '横版 1920×1080', posterOutputBoarding: '长版登机牌 2400×960',
    generateTicketPng: '生成赛季机票 PNG', generateFilmPosterPng: '生成电影海报 PNG', generateMovieTicketPng: '生成首映电影票 PNG', generateDirectorCutPng: '生成导演剪辑版 PNG',
    downloadTicketPng: '下载赛季机票', downloadFilmPosterPng: '下载电影海报', downloadMovieTicketPng: '下载首映电影票', downloadDirectorCutPng: '下载导演剪辑版',
    previewEmptyTicket: '生成后将显示完整横版赛季机票', previewEmptyFilmPoster: '生成后将显示完整竖版电影海报', previewEmptyMovieTicket: '生成后将显示完整横版首映电影票', previewEmptyDirectorCut: '生成后将显示完整横版导演剪辑版',
    keepsakeTip: '可切换生成赛季机票、电影海报、首映电影票或导演剪辑版。电脑端可直接下载，手机端可分享或打开图片后长按保存。',
    viewerId: '观众战网 ID / 昵称', viewerIdPlaceholder: '例如：你的战网ID#1234，也可以只填昵称',
    viewerIdHelp: '这个 ID 会写入赛事见证票；不填写时会生成一张通用见证票。',
    previewFullSize: '放大预览', keepsakePreviewReady: '预览已就绪', keepsakeFileReady: 'PNG 已生成', keepsakeRendering: '正在生成预览…', keepsakeSaveHint: '先放大看看细节，再保存这张属于你的赛季纪念。',
    ...
    boardingPassPreviewAlt: '赛季机票成片预览', filmPosterPreviewAlt: '电影海报成片预览', movieTicketPreviewAlt: '首映电影票成片预览', directorCutPreviewAlt: '导演剪辑版成片预览',
  ...
  'en-US': {
    ...
    storyNavigation: 'Review chapters', recordNote: 'About this record', keepsakeShort: 'Make keepsake', witnessShort: 'Witness pass', letterShort: 'Final letter',
    copyScene: 'Copy scene link', sceneCopied: 'Scene link copied', sceneCopyFailed: 'Copy unavailable. Copy the link below.', sceneLink: 'Current scene link',
    retryGenerate: 'Try again', ticketUse: 'Keep your identity and season record together in a landscape keepsake.',
    posterUse: 'A portrait composition with your name in the spotlight, ready for phone viewing and social sharing.', movieTicketUse: 'Keep the season theme and your name in a landscape premiere ticket.', directorCutUse: 'Choose a hero and its visual style to make your own Director’s Cut.',
    ...
    ticketFormat: 'Landscape season boarding pass', filmPosterFormat: 'Portrait film poster', movieTicketFormat: 'Landscape premiere movie ticket', directorCutFormat: "Director's Cut",
    directorArtDirection: 'Director art direction', directorAllHeroes: 'All hero designs',
    directorAutoSignature: 'Auto · signature hero', directorSeasonCast: 'Season cast', directorChooseHero: 'Choose a hero',
    directorHeroHelpPlayer: "The season's signature hero is used by default. A manual pick changes both the hero render and its visual motif, and marks the ticket as DIRECTOR'S CHOICE.",
    directorHeroHelpIdentity: 'Choose a hero first. The hero becomes the on-screen lead while your name, role, and season record remain intact.',
    directorChoiceSignature: 'Signature hero', directorChoiceManual: "Director's choice", directorChoiceUnselected: 'Awaiting selection',
    directorSubject: 'On-screen lead', directorSubjectHero: 'Hero render', directorSubjectPending: 'Awaiting hero',
    directorChooseHeroPreview: "Choose a hero to generate a ticket from that hero's composition, secondary color, and signature visual motif.",
    directorChooseHeroFirst: 'Choose a hero first.',
    directorRoleTank: 'Tank', directorRoleDamage: 'Damage', directorRoleSupport: 'Support',
    posterOutputPortrait: 'Portrait 1080×1920', posterOutputLandscape: 'Landscape 1920×1080', posterOutputBoarding: 'Boarding pass 2400×960',
    generateTicketPng: 'Generate season boarding pass', generateFilmPosterPng: 'Generate film poster', generateMovieTicketPng: 'Generate premiere movie ticket', generateDirectorCutPng: "Generate Director's Cut",
    downloadTicketPng: 'Download boarding pass', downloadFilmPosterPng: 'Download film poster', downloadMovieTicketPng: 'Download movie ticket', downloadDirectorCutPng: "Download Director's Cut",
    previewEmptyTicket: 'Your complete landscape season boarding pass will appear here', previewEmptyFilmPoster: 'Your complete portrait film poster will appear here', previewEmptyMovieTicket: 'Your complete landscape premiere movie ticket will appear here', previewEmptyDirectorCut: "Your complete landscape Director's Cut will appear here",
    keepsakeTip: "Choose a season boarding pass, film poster, premiere movie ticket, or Director's Cut. Download on desktop, or share and save on mobile.",
    ...
    previewFullSize: 'View full size', keepsakePreviewReady: 'Preview ready', keepsakeFileReady: 'PNG ready', keepsakeRendering: 'Preparing preview…', keepsakeSaveHint: 'Take a closer look, then save your season keepsake.',
    ...
    boardingPassPreviewAlt: 'Season boarding pass preview', filmPosterPreviewAlt: 'Film poster preview', movieTicketPreviewAlt: 'Premiere movie ticket preview', directorCutPreviewAlt: "Director's Cut preview",
  ...
  'ko-KR': {
    ...
    storyNavigation: '리뷰 장면', recordNote: '기록 안내', keepsakeShort: '기념 이미지', witnessShort: '관람권 만들기', letterShort: '마지막 편지',
    copyScene: '이 장면 링크 복사', sceneCopied: '장면 링크를 복사했습니다', sceneCopyFailed: '복사하지 못했습니다. 아래 링크를 복사해 주세요.', sceneLink: '현재 장면 링크',
    retryGenerate: '다시 생성', ticketUse: '이름과 시즌 기록을 한 장의 가로형 기념 티켓으로 간직하세요.',
    posterUse: '이름이 돋보이는 세로형 이미지로, 모바일 감상과 소셜 공유에 어울립니다.', movieTicketUse: '시즌의 테마와 내 이름을 가로형 프리미어 영화 티켓에 담습니다.', directorCutUse: '영웅과 전용 미술 스타일을 골라 나만의 감독판을 만드세요.',
    ticketFormat: '가로형 시즌 탑승권', filmPosterFormat: '세로형 영화 포스터', movieTicketFormat: '가로형 프리미어 영화 티켓', directorCutFormat: '감독판',
    directorArtDirection: '감독 미술 방향', directorAllHeroes: '전체 영웅 디자인',
    directorAutoSignature: '자동 · 시즌 대표 영웅', directorSeasonCast: '이번 시즌 출연', directorChooseHero: '영웅 선택',
    directorHeroHelpPlayer: '기본값은 시즌 대표 영웅입니다. 직접 고르면 영웅 렌더와 전용 시각 모티프가 함께 바뀌고 티켓에 DIRECTOR’S CHOICE가 표시됩니다.',
    directorHeroHelpIdentity: '먼저 영웅을 선택하세요. 영웅이 영화 티켓의 화면 주인공이 되고 이름, 역할, 시즌 기록은 그대로 남습니다.',
    directorChoiceSignature: '시즌 대표', directorChoiceManual: '감독 선택', directorChoiceUnselected: '선택 대기',
    directorSubject: '화면 주인공', directorSubjectHero: '영웅 렌더', directorSubjectPending: '영웅 대기',
    directorChooseHeroPreview: '영웅을 선택하면 해당 영웅의 전용 구도, 보조색, 시각 모티프로 영화 티켓을 자동 생성합니다.',
    directorChooseHeroFirst: '먼저 영웅을 선택해 주세요.',
    directorRoleTank: '돌격', directorRoleDamage: '공격', directorRoleSupport: '지원',
    posterOutputPortrait: '세로형 1080×1920', posterOutputLandscape: '가로형 1920×1080', posterOutputBoarding: '와이드 탑승권 2400×960',
    generateTicketPng: '시즌 탑승권 생성', generateFilmPosterPng: '영화 포스터 생성', generateMovieTicketPng: '프리미어 영화 티켓 생성', generateDirectorCutPng: '감독판 생성',
    downloadTicketPng: '탑승권 다운로드', downloadFilmPosterPng: '영화 포스터 다운로드', downloadMovieTicketPng: '영화 티켓 다운로드', downloadDirectorCutPng: '감독판 다운로드',
    previewEmptyTicket: '완성된 가로형 시즌 탑승권이 여기에 표시됩니다', previewEmptyFilmPoster: '완성된 세로형 영화 포스터가 여기에 표시됩니다', previewEmptyMovieTicket: '완성된 가로형 프리미어 영화 티켓이 여기에 표시됩니다', previewEmptyDirectorCut: '완성된 가로형 감독판이 여기에 표시됩니다',
    keepsakeTip: '시즌 탑승권, 영화 포스터, 프리미어 영화 티켓, 감독판 중에서 선택할 수 있습니다. PC에서는 다운로드하고 모바일에서는 공유하거나 길게 눌러 저장하세요.',
    ...
    previewFullSize: '크게 보기', keepsakePreviewReady: '미리보기 준비 완료', keepsakeFileReady: 'PNG 준비 완료', keepsakeRendering: '미리보기 생성 중…', keepsakeSaveHint: '크게 보며 확인한 뒤, 당신의 시즌 기념물을 저장하세요.',
    ...
    boardingPassPreviewAlt: '시즌 탑승권 완성본 미리보기', filmPosterPreviewAlt: '영화 포스터 완성본 미리보기', movieTicketPreviewAlt: '프리미어 영화 티켓 완성본 미리보기', directorCutPreviewAlt: '감독판 완성본 미리보기',
...
export function reviewText(locale, key) {
  ...
  if (normalized === 'zh-TW') return localizeTraditionalReview(UI_COPY['zh-CN'][key] ?? key)
  return UI_COPY[normalized]?.[key] ?? translateUiText(UI_COPY['zh-CN'][key] ?? key, normalized)
}

export function getReviewIdentities(locale, eventNoun = '赛事') {
  const normalized = normalizeReviewLocale(locale)
  if (normalized === 'zh-TW') return localizeTraditionalReview(getReviewIdentities('zh-CN', eventNoun))
  return (IDENTITY_COPY[normalized] || IDENTITY_COPY['zh-CN']).map(([id, no, title, shortTitle, en, desc, hint]) => ({
...
export function getReviewPlaceholder(locale, identity) {
  if (normalizeReviewLocale(locale) === 'zh-TW') return localizeTraditionalReview(getReviewPlaceholder('zh-CN', identity))
...
const TOKEN_COPY = {
  'en-US': {
    ...
    '承压空间': 'Damage mitigation', '前排输出': 'Frontline damage', '击杀参与': 'Elimination involvement',
    '治疗支撑': 'Healing support', '团队连接': 'Team support', '反打参与': 'Fight involvement',
    '生存控制': 'Survivability', '持续火力': 'Sustained damage', '击杀转化': 'Elimination output', '团队联动': 'Team coordination',
    '单图治疗': 'Healing on one map', '单图伤害': 'Damage on one map', '单图阻挡': 'Mitigation on one map',
    '击杀': 'Eliminations', '死亡': 'Deaths', '伤害': 'Damage', '治疗': 'Healing', '助攻': 'Assists', '阻挡': 'Mitigation',
    '去重地图记录': 'Distinct map records', '常驻地图：': 'Most-played map: ', '常驻地图': 'Most-played map', '代表英雄：': 'Signature hero: ',
    '公开预选赛参与者': 'Open Qualifier participant', '季后淘汰赛参与者': 'Playoff participant',
    '决赛路上的参与者': 'Part of the run to the final', '终局附近的参赛者': 'Late-stage competitor',
    '冠军路上的名字': 'Part of the championship run', '被记录下来的参赛者': 'Recorded participant',
    '长线出场者': 'Regular in the lineup', '长时间参赛者': 'Long-serving player', '持续火力点': 'Sustained damage source',
    '机会终结者': 'Opportunity finisher', '团队支撑点': 'Team anchor', '场上留存者': 'Staying in the fight',
    '前排空间制造者': 'Frontline space maker', '队伍支撑者': 'Team support', '使用者': 'player',
    '对手最终停在公开预选赛': 'Opponent finished in the Open Qualifier',
    '这支队伍最终停在公开预选赛': 'This team finished in the Open Qualifier',
    '公开出场记录': 'Published appearance records', '身份记录': 'Role record', '常规赛身份': 'Regular-season role',
    '记录截至常规阶段': 'Record ends with the regular stage', '跨队伍选手': 'Multi-team player', '经理': 'Manager',
    '比赛归档': 'Match archive', '队伍归档': 'Team archive', '地图坐标': 'Map archive',
    '场公开记录': 'published match records', '支参赛队伍': 'participating teams', '张被记录的地图': 'distinct maps recorded',
    '最后，在见证票上签下自己的名字': 'Finally, sign your name on the witness ticket',
    '它不会声称你看过哪一场，只确认这届比赛曾经被你看见。': 'It does not claim which matches you watched. It simply keeps your name as a witness to this season.',
    '你看见过': 'You watched', '你在意过': 'You cared', '你也在这届比赛里': 'You were part of this season too',
    '公开赛程': 'Published schedule', '次记录': ' records'
  },
  'ko-KR': {
    ...
    '承压空间': '피해 흡수', '前排输出': '전방 화력', '击杀参与': '처치 관여',
    '治疗支撑': '치유 지원', '团队连接': '팀 지원', '反打参与': '교전 관여',
    '生存控制': '생존 관리', '持续火力': '지속 화력', '击杀转化': '처치 전환', '团队联动': '팀 연계',
    '单图治疗': '단일 전장 치유량', '单图伤害': '단일 전장 피해량', '单图阻挡': '단일 전장 방어량',
    '击杀': '처치', '死亡': '죽음', '伤害': '피해', '治疗': '치유', '助攻': '도움', '阻挡': '방어',
    '去重地图记录': '중복을 제외한 전장 기록', '常驻地图：': '가장 많이 뛴 전장: ', '常驻地图': '가장 많이 뛴 전장', '代表英雄：': '대표 영웅: ',
    '公开预选赛参与者': '공개 예선 참가자', '季后淘汰赛参与者': '플레이오프 참가자',
    '决赛路上的参与者': '결승 여정의 일원', '终局附近的参赛者': '시즌 후반의 참가자',
    '冠军路上的名字': '우승 여정의 일원', '被记录下来的参赛者': '기록에 남은 참가자',
    '长线出场者': '꾸준히 출전한 선수', '长时间参赛者': '오랜 시간을 남긴 선수', '持续火力点': '지속적인 화력',
    '机会终结者': '기회를 마무리하는 선수', '团队支撑点': '팀의 버팀목', '场上留存者': '교전에 남는 선수',
    '前排空间制造者': '전방 공간을 만드는 선수', '队伍支撑者': '팀의 지원자', '使用者': '플레이어',
    '对手最终停在公开预选赛': '상대는 공개 예선에서 여정을 마쳤습니다',
    '这支队伍最终停在公开预选赛': '이 팀은 공개 예선에서 여정을 마쳤습니다',
    '公开出场记录': '공개 출전 기록', '身份记录': '역할 기록', '常规赛身份': '정규 시즌 역할',
    '记录截至常规阶段': '기록은 정규 단계까지', '跨队伍选手': '여러 팀에서 뛴 선수', '经理': '매니저',
    '比赛归档': '경기 아카이브', '队伍归档': '팀 아카이브', '地图坐标': '전장 아카이브',
    '场公开记录': '개의 공개 경기 기록', '支参赛队伍': '개 참가 팀', '张被记录的地图': '개 전장 기록',
    '最后，在见证票上签下自己的名字': '마지막으로, 관람권에 이름을 남겨 주세요',
    '它不会声称你看过哪一场，只确认这届比赛曾经被你看见。': '어떤 경기를 봤는지 대신 단정하지 않습니다. 이 시즌을 지켜본 사람으로 당신의 이름을 남깁니다.',
    '你看见过': '당신은 지켜봤습니다', '你在意过': '당신은 마음을 썼습니다', '你也在这届比赛里': '당신도 이 시즌의 일부입니다',
    '公开赛程': '공개 일정', '次记录': '회 기록'
  }
}
...
function translateToken(value, locale) {
  const normalized = normalizeReviewLocale(locale)
  if (normalized === 'zh-TW') return localizeTraditionalReview(value)
  if (normalized === 'zh-CN' || typeof value !== 'string' || /#\d+$/.test(value)) return value
  ...
  if (normalized === 'en-US') {
    text = text.replace(/第\s*(\d+)\s*名/g, '#$1').replace(/第\s*(\d+)\s*轮/g, 'Round $1')
      .replace(/(\d+)\s*张(?:Maps?)?/g, (_, count) => `${count} ${count === '1' ? 'map' : 'maps'}`)
      .replace(/(\d+)\s*场(?:Matches?)?/g, (_, count) => `${count} ${count === '1' ? 'match' : 'matches'}`)
      .replace(/(\d+)\s*支Team/g, (_, count) => `${count} ${count === '1' ? 'team' : 'teams'}`)
      .replace(/(\d+)\s*条记录/g, (_, count) => `${count} ${count === '1' ? 'record' : 'records'}`)
      .replace(/(\d+)\s*次/g, '$1 times')
      .replace(/(Eliminations|Deaths|Damage|Healing|Assists|Mitigation)\s*\/10\b/g, '$1 /10 min')
  } else {
    text = text.replace(/第\s*(\d+)\s*名/g, '$1위').replace(/第\s*(\d+)\s*轮/g, '$1라운드')
      .replace(/(\d+)\s*张(?:전장)?/g, '$1개 전장').replace(/(\d+)\s*场(?:경기)?/g, '$1경기')
      .replace(/(\d+)\s*支팀/g, '$1개 팀').replace(/(\d+)\s*条记录/g, '$1개 기록')
      .replace(/(\d+)\s*次/g, '$1회')
      .replace(/(처치|죽음|피해|치유|도움|방어)\s*\/10\b/g, '$1 /10분')
  }
  return text
}
...
function getSceneContext(scenes, profile = {}) {
  ...
  const partnerCount = card => Number(String(card.value || '').match(/\d+/)?.[0] || 0)
  const partnerCard = [
    ...(partnerScene.partnerCards || []),
    ...(partnerScene.crossPartnerCards || []),
    ...(partnerScene.partnerGroups || []).flatMap(group => group.cards || [])
  ].sort((a, b) => partnerCount(b) - partnerCount(a))[0] || {}
  ...
  return {
    ...
    partnerCount: partnerCount(partnerCard),
    ...
    hasRosterChange: scenes.some(scene => scene.eyebrow === 'POSTSEASON ROSTER'),
...
function localizeCard(card, locale, options = {}) {
  ...
  return {
    ...card,
    sourceLabel: card.sourceLabel || card.label,
    title: options.match && /[\u4e00-\u9fff]/.test(String(card.title || ''))
      ? (normalized === 'ko-KR' ? '경기의 기억' : 'Match memory')
      : options.preserveTitle ? card.title : translateToken(card.title, normalized),
...
function localizeGroup(group, locale) {
  return {
    ...
    cards: group.cards?.map(card => localizeCard(card, locale, { preserveTitle: true }))
  }
}
...
export function localizeReviewScenes(scenes, locale, profile = {}) {
  ...
  return scenes.map(scene => {
    ...
    const localized = {
      ...
      coverRole: translateToken(scene.coverRole, normalized),
      coverHeroName: translateToken(scene.coverHeroName, normalized),
      coverStats: scene.coverStats?.map(item => localizeCard(item, normalized)),
      identityClass: translateToken(scene.identityClass, normalized),
      identity_class: translateToken(scene.identity_class, normalized),
      eventTitle: profile.eventTitle || translateToken(scene.eventTitle, normalized),
      event_title: profile.eventTitle || translateToken(scene.event_title, normalized),
      eventNoun: profile.eventNoun || translateToken(scene.eventNoun, normalized),
      event_noun: profile.eventNoun || translateToken(scene.event_noun, normalized),
      ...
      sourceMetricLabel: scene.sourceMetricLabel || scene.metricLabel,
      ...
      teamCards: scene.teamCards?.map(item => localizeCard(item, normalized, { preserveTitle: true })),
      playerCards: scene.playerCards?.map(item => localizeCard(item, normalized, { preserveTitle: true })),
      rosterCards: scene.rosterCards?.map(item => localizeCard(item, normalized, { preserveTitle: true })),
      partnerCards: scene.partnerCards?.map(item => localizeCard(item, normalized, { preserveTitle: true })),
      crossPartnerCards: scene.crossPartnerCards?.map(item => localizeCard(item, normalized, { preserveTitle: true })),
      ...
      memoryCoordinates: scene.memoryCoordinates?.map(item => localizeCard(item, normalized)),
      witnessStats: scene.witnessStats?.map(item => localizeCard(item, normalized)),
      witnessPrompt: scene.witnessPrompt ? {
        ...scene.witnessPrompt,
        title: translateToken(scene.witnessPrompt.title, normalized),
        body: translateToken(scene.witnessPrompt.body, normalized)
      } : undefined,
...
export function localizeReviewSearchResult(item, locale) {
  ...
  if (normalized === 'zh-TW') return { ...item, subtitle: localizeTraditionalReview(item.subtitle, [item.label]) }

  const isKo = normalized === 'ko-KR'
  // Translate complete role phrases before the generic token pass splits them.
  const sourceSubtitle = String(item.subtitle || '')
    .replace(/解说\s*(\d+)\s*场比赛/g, isKo ? '$1경기 중계' : 'Cast $1 matches')
    .replace(/｜赛管\s*\/\s*裁判\s*\/\s*导播合并统计/g, isKo ? '｜운영 역할 통합 기록' : '｜combined operations roles')
    .replace(/｜经理\s*\/\s*教练视角/g, isKo ? '｜매니저 / 코치 시점' : '｜manager / coach view')
  let subtitle = translateToken(sourceSubtitle, normalized)
  if (normalized === 'ko-KR') {
    subtitle = subtitle
...
export function getReviewPosterMeta(kind, locale) {
  const normalized = normalizeReviewLocale(locale)
  if (normalized === 'zh-TW') return localizeTraditionalReview(getReviewPosterMeta(kind, 'zh-CN'))
  const labels = {
